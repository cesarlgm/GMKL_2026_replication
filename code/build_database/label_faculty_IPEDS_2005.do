...
*	Description: 	Imports the IPEDS 2005 fall staff (faculty) CSV, applies variable and value labels for academic rank categories, and saves the labeled dataset to data/temporary/.

*===============================================================================
*/
insheet using "data/raw/faculty_IPEDS_2005.csv", clear
label data STATA_RV_8162024_429
...
save "data/temporary/labeled_faculty_IPEDS_2005", replace