...
*	Description: 	Imports the IPEDS 2017 enrollment CSV, applies variable and value labels for enrollment level categories, and saves the labeled dataset to data/temporary/.

*===============================================================================
*/
insheet using "data/raw/enrollment_IPEDS_2017.csv", clear
label data STATA_RV_8192024_106
...
save "data/temporary/labeled_enrollment_IPEDS_2017", replace